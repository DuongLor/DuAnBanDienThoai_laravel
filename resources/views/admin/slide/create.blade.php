...
@section('title', 'Admin - Slide ')
@section('content')
    <form action="{{ route('adminSlide.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card mb-3">
            <div class="card-body">
                <div class="form-group pb-2 align-items-center">
                    <label class="mr-2 mb-2"><i class="fas fa-pen"></i> Tên Slide</label>
