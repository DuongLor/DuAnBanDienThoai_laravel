                    ...
                    <div class="row row-cols-3 mt-3">
                        ...
                        <div class="form-check col">
                            <input type="hidden" name="discount"
                                value="{{ $color->pivot->discount }}">
                            <input type="hidden" name="price" value="{{ $color->pivot->price }}">
                            <input class="form-check-input" type="radio" value="{{ $color->id }}"
                                name="color" id="">
                            <input type="hidden" name="quantity"
                                value="{{$color->pivot->quantity}}">
                                    ...
                                    <div class="w-100">
                                        <div class="row  mb-3">
                                            <h6 class="text-primary fw-bold mb-0 col-10">
                                                {{$review->user->name}}
                                                <span
                                                    class="text-dark ms-2">{{$review->comment}}</span>
                                            </h6>
                                            <div class="col-2">
                                                <p class="mb-0">
